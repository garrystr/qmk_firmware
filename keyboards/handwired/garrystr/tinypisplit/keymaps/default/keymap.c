...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_Z,    KC_X,           KC_C,           KC_V,           KC_B,    KC_N,    KC_M,           KC_COMM,      KC_DOT,          KC_MINS,
                             KC_SCLN,        KC_BSPC,        SFT_T(KC_SPC),    TD(ENT_LAYER_CAPS), KC_SLSH),
  ...
  */
  ...
  [_DVORAK] = LAYOUT(
    ...
    KC_Z,    KC_Q,        KC_J,        KC_K,        KC_X, KC_B,    KC_M,        KC_W,          KC_V,         KC_MINS,
                          KC_SCLN,     KC_BSPC,     SFT_T(KC_SPC), TD(ENT_LAYER_CAPS), KC_SLSH),
  ...
  */
  ...
  [_NUMS] = LAYOUT(
    ...
    KC_GRV,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_NUHS, KC_NUBS,    KC_NO,     KC_NO,  KC_LBRC, KC_RBRC,
    KC_SCLN, KC_BSLS,  KC_NO,    KC_LEFT,  KC_UP,   KC_DOWN,    KC_RIGHT,    KC_COMM, KC_DOT,  KC_MINS,
                       KC_EQL,   KC_BSPC,     SFT_T(KC_SPC),    TD(ENT_LAYER_CAPS),   KC_SLSH),
  ...
  */
  ...
  [_FUNCT] = LAYOUT(
    ...
    RGB_TOG, RGB_MOD, RGB_RMOD,RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_M_T,
                               KC_NO,   KC_BSPC, SFT_T(KC_SPC),    TD(ENT_LAYER_CAPS), KC_NO),
  ...
  */
  ...
  [_MOUSE] = LAYOUT(
    ...
    KC_ACL2,  KC_NO,  KC_NO, KC_WH_L,   KC_MS_D,   KC_WH_D,   KC_WH_R,   KC_NO,   KC_NO,   KC_NO,
                      KC_NO, KC_NO,     KC_NO,     TD(ENT_LAYER_CAPS),   KC_NO),
  ...
  */
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______, COLEMAK,  _______, _______, NUMS,    MOUSE,   _______, _______, _______,
                      RESET,    KC_DEL,  KC_TAB,           _______, KC_ESC)
};
